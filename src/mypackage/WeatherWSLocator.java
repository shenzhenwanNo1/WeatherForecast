...
public class WeatherWSLocator extends org.apache.axis.client.Service implements mypackage.WeatherWS {
 ...
 */
    ...
    public mypackage.WeatherWSSoap_PortType getWeatherWSSoap12() throws javax.xml.rpc.ServiceException {
    ...
    public mypackage.WeatherWSSoap_PortType getWeatherWSSoap12(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mypackage.WeatherWSSoap12Stub _stub = new mypackage.WeatherWSSoap12Stub(portAddress, this);
    ...
    public mypackage.WeatherWSSoap_PortType getWeatherWSSoap() throws javax.xml.rpc.ServiceException {
       java.net.URL endpoint;
        try {
    ...
    public mypackage.WeatherWSSoap_PortType getWeatherWSSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            mypackage.WeatherWSSoap_BindingStub _stub = new mypackage.WeatherWSSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (mypackage.WeatherWSSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                mypackage.WeatherWSSoap12Stub _stub = new mypackage.WeatherWSSoap12Stub(new java.net.URL(WeatherWSSoap12_address), this);
                _stub.setPortName(getWeatherWSSoap12WSDDServiceName());
                return _stub;
            }
            if (mypackage.WeatherWSSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                mypackage.WeatherWSSoap_BindingStub _stub = new mypackage.WeatherWSSoap_BindingStub(new java.net.URL(WeatherWSSoap_address), this);
                _stub.setPortName(getWeatherWSSoapWSDDServiceName());
                return _stub;
            }
        }

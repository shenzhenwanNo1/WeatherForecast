...
public class GetSupportCityDatasetResponse  implements java.io.Serializable {
    private mypackage.GetSupportCityDatasetResponseGetSupportCityDatasetResult getSupportCityDatasetResult;

    public GetSupportCityDatasetResponse() {
    }

    public GetSupportCityDatasetResponse(
           mypackage.GetSupportCityDatasetResponseGetSupportCityDatasetResult getSupportCityDatasetResult) {
     ...
     */
    public mypackage.GetSupportCityDatasetResponseGetSupportCityDatasetResult getGetSupportCityDatasetResult() {
        return getSupportCityDatasetResult;
    }
     ...
     */
    public void setGetSupportCityDatasetResult(mypackage.GetSupportCityDatasetResponseGetSupportCityDatasetResult getSupportCityDatasetResult) {
        this.getSupportCityDatasetResult = getSupportCityDatasetResult;
    }
